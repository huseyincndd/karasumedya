  ...
  return (
    <main className="min-h-screen pb-16">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-600 via-pink-700 to-rose-800">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10 pt-32 pb-20">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white mb-6 shadow-lg">
              ...
              <span className="font-medium">İçerik Çözümleri</span>
            </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
              href="/iletisim" 
              className="px-10 py-5 bg-white text-purple-700 font-bold rounded-2xl hover:bg-purple-50 transition-all duration-300 inline-flex items-center shadow-2xl hover:shadow-purple-200/50 hover:scale-105 text-lg"
            >
